        ...
        <div className={styles.textContainer}>
          ...
          >
            <p className={styles.description}>
              ...
              Contemporaneidade pelo Instituto Freedom , e Psicoterapia Pessoal
              há 6 anos.
            </p>
            <p className={styles.description}>
              Meu objetivo como Psicóloga é tratar os transtornos mentais,
              aliviar o sofrimento mental, promover o autoconhecimento, para que
              o paciente torne se “a si mesmo”, buscando a consciência
              necessária, para transitar pela vida criando novos caminhos. Estou
              trilhando um caminho pessoal motivada pelo que me brilha os olhos
              que é ser Psicóloga Clínica, estar neste lugar me inspira a ser
              uma profissional mais competente, ética e humana proporcionando a
