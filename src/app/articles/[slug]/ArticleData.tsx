...
export default async function ArticleData({ slug }: ArticleDataProps) {
  ...
  const schemaArticle = {
    ...
    "@type": "Article",
    "@id": `https://www.rodepsi.com/articles/${slug}#article`,
    ...
    "inLanguage": "pt-BR",
    "url": `https://www.rodepsi.com/articles/${slug}`,
    "author": {
      "@type": "Person",
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": `https://www.rodepsi.com/articles/${slug}`,
    },
    ...
    <>
      ...
      <div className={styles.layoutGrid}>
        <div className={styles.article}>
          <span className={styles.categoryName}>{article.categoryName}</span>
